  ...
  return (
    <section id="download" className="relative py-24 bg-[#121212]">
      ...
      <div className="relative container mx-auto px-4 md:px-6">
        <div className="glass-card rounded-3xl p-8 md:p-16 bg-gradient-to-r from-[#FFB800]/20 to-[#FFD54A]/20 border-2 border-[#FFB800]/30 overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6">
              <a
                href="https://expo.dev/artifacts/eas/dLXiyRg6E1jiqNRanzYNsL.apk"
